...
INSERT INTO income(amount,income_date,user_id) VALUES(2500.00,'2020-08-10',1);
INSERT INTO income(amount,income_date,user_id) VALUES(2600.00,'2020-08-10',1);

Insert into income(amount,income_date, user_id) values (5000.00, '2020-08-11',1);
...
INSERT INTO expenditure(amount,expenditure_date,user_id) VALUES(24.56,'2020-08-12',1);
INSERT INTO expenditure(amount,expenditure_date,note,user_id) VALUES(99.99,'2020-08-10','jacket',1);
INSERT INTO expenditure(amount,expenditure_date,note,user_id) VALUES(52.39,'2020-08-15','fruit for birthday',2);
...
INSERT into PLANNED_CASH_FLOW (NAME,CURRENT_SUM_AMOUNT,END_DATE,IS_SUM_AMOUNT_EXCEEDED,NOTE,PLANNED_AMOUNT,START_DATE,USER_ID) VALUES('Food',0.00,'2020-08-31',false,'note1',1500.00,'2020-08-01',1);
INSERT into PLANNED_CASH_FLOW (NAME,CURRENT_SUM_AMOUNT,END_DATE,IS_SUM_AMOUNT_EXCEEDED,NOTE,PLANNED_AMOUNT,START_DATE,USER_ID) VALUES('Food in work',0.00,'2020-08-31',false,'note1',200.00,'2020-08-01',1);

INSERT INTO expenditure(amount,expenditure_date,user_id,PLANNED_CASH_FLOW_ID ) VALUES(90,'2020-08-12',1,1);
INSERT INTO expenditure(amount,expenditure_date,user_id,PLANNED_CASH_FLOW_ID ) VALUES(110,'2020-08-14',1,1);
